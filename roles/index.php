...
<head>
    ...
    <title>Role Cards - No Bad Ideas</title>
...
<body class="bg-gray-900 text-white flex flex-col items-center justify-center min-h-screen">
    ...
    <div class="container mx-auto p-4 md:p-8 w-full max-w-md">
        <header class="text-center mb-8">
            <h1 id="deck-title" class="text-4xl font-bold tracking-tight">Role Cards</h1>
        ...
        <div id="card-container" class="perspective-1000">
            <div id="card" class="card relative w-full" style="aspect-ratio: 3/4;">
                ...
                <div id="card-front" class="card-face absolute w-full h-full rounded-lg shadow-lg flex flex-col items-center justify-center p-6">
                    ...
                    <img id="card-image-front" src="" alt="Role Image" class="w-full h-full object-contain">
                </div>
                <!-- Card Back -->
        ...
        <div class="flex justify-between items-center mt-6">
            ...
            <button id="flip-card" class="bg-sky-600 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-colors">See Details</button>
    ...
    <script>
        // Initialize the deck viewer for the Roles deck
        document.addEventListener('DOMContentLoaded', () => {
            initializeDeck('roles');
